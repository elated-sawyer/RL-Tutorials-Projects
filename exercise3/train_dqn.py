...
CARTPOLE_CONFIG = {
    ...
    "eval_episodes": 5,
    "learning_rate": 5e-4, #original 1e-2, too large
    "hidden_size": (128,), #original (128,64) 2021.4.3
    "target_update_freq": 150, #original 5000 80 150
    "batch_size": 40, # original 10 too small
    "gamma": 0.99,
...
LUNARLANDER_CONFIG = {
    ...
    "learning_rate": 1e-3, #original 1e-2, too large
    "hidden_size": (128, 64), #original (128, 64)
    "target_update_freq": 400, #original 5000, 75 too small
    "batch_size": 80, # original 10 too small 50
    "gamma": 0.99,
    "buffer_capacity": int(1e6),
    "plot_loss": True,
